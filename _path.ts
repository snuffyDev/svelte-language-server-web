...
const { basename: basename3 , delimiter: delimiter3 , dirname: dirname3 , extname: extname3 , format: format3 , fromFileUrl: fromFileUrl3 , isAbsolute: isAbsolute3 , join: join4 , normalize: normalize4 , parse: parse3 , relative: relative3 , resolve: resolve3 , sep: sep2 , toFileUrl: toFileUrl3 , toNamespacedPath: toNamespacedPath3  } = mod1;
export { basename3 as basename, delimiter3 as delimiter, dirname3 as dirname, extname3 as extname, format3 as format, fromFileUrl3 as fromFileUrl, isAbsolute3 as isAbsolute, join4 as join, normalize4 as normalize, parse3 as parse, relative3 as relative, resolve3 as resolve, sep2 as sep, toFileUrl3 as toFileUrl, toNamespacedPath3 as toNamespacedPath };
