...
import {
	IPCMessageReader,
	IPCMessageWriter as BrowserMessageWriter,
	createConnection,
...
import { FileStat, FileType } from "@vscode/emmet-helper";
const ctime = Date.now();

// FileSystemProvider adapted to work in browser (avoids doing stat calls)
// @ts-expect-error it's fine it's not fully implemented
