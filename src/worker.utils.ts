// credit: https://github.com/denoland/deno_std/blob/main/collections/_utils.ts
...
const hasOwn = function (o: object, key: PropertyKey) {
...
>(
	...
	const keys = new Set([...getKeys(record), ...getKeys(other)]) as Set<
		keyof Result
	>;
