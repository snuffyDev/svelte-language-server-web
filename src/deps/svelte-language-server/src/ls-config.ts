...
export class LSConfigManager {
  ...
  private _updateTsUserPreferences(
    ...
    this.tsUserPreferences[lang] = {
      ...
      autoImportFileExcludePatterns:
        config.preferences?.autoImportFileExcludePatterns,
  ...
  getTsUserPreferences(
    ...
    if (!autoImportFileExcludePatterns) {
      autoImportFileExcludePatterns =
        userPreferences.autoImportFileExcludePatterns.map((p) => {
  ...
  async getFormatCodeSettingsForFile(
    ...
    const indentSize =
      (typeof prettierConfig.tabWidth === "number"
        ...
        : null) ?? tsFormatCodeOptions.tabSize;
    ...
    return {
      ...
      baseIndentSize:
        prettierConfig.svelteIndentScriptAndStyle === false ? 0 : indentSize,
      indentSize,
