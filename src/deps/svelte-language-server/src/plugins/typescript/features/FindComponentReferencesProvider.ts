import { Location, Position, Range } from "vscode-languageserver/browser";
import {
	flatten,
...
export class FindComponentReferencesProviderImpl
	implements FindComponentReferencesProvider
{
